...
pub(crate) struct TargetCollisionHit {
...
#[derive(Clone, Debug, PartialEq)]
pub(crate) struct TargetCollisionResult {
    pub evaluated: bool,
    pub hit: Option<TargetCollisionHit>,
}

#[derive(Clone, Copy)]
pub(crate) struct AttackMask<'a> {
...
pub(crate) fn resolve_target_point_hit(
...
pub(crate) fn resolve_target_mask_hit(
    target: CollisionTarget<'_>,
    attack: AttackMask<'_>,
    camera_world: IVec2,
    assets: &mut MaskCollisionAssets<'_, '_>,
...
pub(crate) fn visit_target_debug_collider<FMask, FPrimitive>(
    target: CollisionTarget<'_>,
    camera_world: IVec2,
    assets: &mut MaskCollisionAssets<'_, '_>,
