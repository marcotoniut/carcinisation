...
//!
//! Core constants (`SCREEN_RESOLUTION`, `HUD_HEIGHT`, etc.) live in
//! [`carcinisation_core::globals`]. This module re-exports them and adds
//! app-specific viewport/window helpers.
